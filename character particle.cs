...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition.aa
{
	public class aa : MonoBehaviour
	{
		...
		private void StartRecordButtonOnClickHandler()
		{
			...
			//_speechRecognition.StartRecord(_isRuntimeDetectionToggle.isOn);//スタート
		}
		void Update(){
		...
		//ここで反応を知れる
		public void RecognitionSuccessEventHandler(RecognitionResponse obj, long requestIndex)
		{
			if (!_isRuntimeDetectionToggle.isOn)
			{
				_startRecordButton.interactable = true;
